...
namespace OfficeExtractor.Ole
{
    ...
    internal class AttachDescStream
    {
        ...
        internal AttachDescStream(BinaryReader binaryReader)
        {
            Version = binaryReader.ReadUInt16();
            LongPathName = Strings.Read1ByteLengthPrefixedString(binaryReader);
            PathName = Strings.Read1ByteLengthPrefixedString(binaryReader);
            DisplayName = Strings.Read1ByteLengthPrefixedString(binaryReader);
