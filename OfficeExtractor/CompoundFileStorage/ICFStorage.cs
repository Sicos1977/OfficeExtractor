...
namespace DocumentServices.Modules.Extractors.OfficeExtractor.CompoundFileStorage
{
    ...
    {
        /// <summary>
        /// Gets a named <see cref="T:DocumentServices.Modules.Extractors.OfficeExtractor.OLECompoundFileStorage.CFStream">stream</see> contained in the current storage if existing.
        /// </summary>
        /// <param name="streamName">Name of the stream to look for</param>
        /// <returns>A stream reference if existing</returns>
        /// <exception cref="T:DocumentServices.Modules.Extractors.OfficeExtractor.OLECompoundFileStorage.CFDisposedException">Raised if trying to delete item from a closed compound file</exception>
        /// <exception cref="T:DocumentServices.Modules.Extractors.OfficeExtractor.OLECompoundFileStorage.CFItemNotFound">Raised if item to delete is not found</exception>
        /// <example>
        /// <code>
        ...
        /// </summary>
        /// <exception cref="T:DocumentServices.Modules.Extractors.OfficeExtractor.OLECompoundFileStorage.CFDisposedException">Raised when visiting items of a closed compound file</exception>
        /// <param name="action">User <see cref="T:DocumentServices.Modules.Extractors.OfficeExtractor.OLECompoundFileStorage.VisitedEntryAction">action</see> to apply to visited entities</param>
        ...
        /// </summary>
        /// <param name="action">
        /// User <see cref="T:DocumentServices.Modules.Extractors.OfficeExtractor.OLECompoundFileStorage.VisitedEntryParamsAction">action</see> to apply to visited 
        /// entities
        /// </param>
